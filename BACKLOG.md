...
- `[?]` **[FEATURE]** Develop new business app idea: An educational app to help non-technical people improve their AI prompts through corrective vocabulary and meaningful examples. (Philosophy: Slow is smooth, smooth is fast). Target: Point to it from the portfolio _(added: 2026-05-02)_
